          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-[#827570]">
                Create a new piece for your
                BellesCart jewelry collection.
              </p>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-5 p-5 sm:p-6">
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        className="h-11 w-full rounded-xl border border-[#ded6d1] bg-[#fdfbf9] px-4 text-sm text-[#30272b] outline-none transition focus:border-[#8c6376] focus:bg-white focus:ring-4 focus:ring-[#8c6376]/10 disabled:cursor-wait disabled:opacity-60"
                      >
                        <option value="">
                          {isLoadingCategories
                            ? 'Loading categories...'
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={6}
                      placeholder="Describe the design, materials, finish, styling and other product details..."
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="jhumka, antique, gold, wedding"
              ...
              <section className="rounded-2xl border border-[#e9e1dc] bg-white shadow-[0_4px_24px_rgba(50,30,30,0.035)]">
                ...
                <div className="p-5 sm:p-6">
                  ...
                  >
                    <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#f2ebe8] text-[#765563]">
                      <UploadIcon />
                    </div>

                    <h3 className="mt-4 text-sm font-semibold text-[#41373b]">
                      {isDragging
                        ? 'Drop your images here'
                        : 'Upload product images'}
                    </h3>

                    <p className="mx-auto mt-1 max-w-sm text-xs leading-5 text-[#988c87]">
                      Drag and drop product
                      photography here, or choose
                    ...
                    <button
                      ...
                      className="mt-5 inline-flex h-10 items-center gap-2 rounded-xl bg-[#351d2d] px-5 text-xs font-semibold text-white shadow-sm transition hover:bg-[#47263d]"
                    >
                      <UploadIcon />
                      Choose Images
                    </button>
            ...
            <aside className="space-y-6 lg:sticky lg:top-24">
              ...
              <section className="rounded-2xl border border-[#e9e1dc] bg-white p-5 shadow-[0_4px_24px_rgba(50,30,30,0.035)]">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    >
                      <span className="text-xs text-[#66595e]">
                        {item.label}
                      </span>
              ...
              <section className="rounded-2xl bg-[#351d2d] p-5 text-white shadow-[0_8px_30px_rgba(53,29,45,0.15)]">
                ...
                <p className="mt-2 font-serif text-lg leading-6">
                  Let the jewelry speak for
                  itself.
                </p>

                <p className="mt-2 text-xs leading-5 text-[#d9cbd1]">
                  Use bright, clean product
                  photography and keep the first
                  image as your strongest visual.
                </p>
              </section>
            </aside>
          </div>
